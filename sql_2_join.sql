...
SELECT CITY.NAME FROM CITY WHERE COUNTRYCODE = (SELECT COUNTRYCODE FROM COUNTRY WHERE CAPITAL = (SELECT ID FROM CITY WHERE NAME = 'Luanda'));

SELECT CITY.NAME FROM CITY JOIN COUNTRY ON CITY.ID = COUNTRY.CAPITAL;
...
SELECT CODE FROM COUNTRY JOIN CITY ON COUNTRY.CODE = CITY.COUNTRYCODE WHERE COUNTRY.REGION = (SELECT REGION FROM COUNTRY WHERE CODE = (SELECT COUNTRYCODE FROM CITY WHERE NAME = 'Yaren'));
#
#
